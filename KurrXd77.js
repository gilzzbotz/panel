...
console.log('\x1b[1;34m~\x1b[1;37m>', '[\x1b[1;33mCMD\x1b[1;37m]', time, color(`${prefix + command} [${args.length}]`, 'cyan'), 'from', color(m.pushName), 'in', color(groupName, 'orange'))
        ...
        // Leveling Punya Chika 🗿🗿 Di Copas Oleh KurrXd
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "KurrXd||77+ ~ Multi Device", "6283155687629@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
const fakey = (teks) => {
            mans.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Join Bot Grup!!`,"body": `Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/KurrXd.jpg`),"sourceUrl": "https://chat.whatsapp.com/DhXoC9dA87V1zZyISwBEkF"}}}, { quoted: m})
        }
const ftextt = {
key: { 
fromMe: false,
...
case 'help':
let butRun = [
        	{ urlButton: { displayText: `WEB STORE`, url : `https://kurrxdstore.my.id` } },
            { urlButton: { displayText: `Contact Me`, url: `+62 812-2067-0449` } },
            { quickReplyButton: { displayText: `Contact Owner`, id: 'owner'} },
            { quickReplyButton: { displayText: `Profile`, id: 'profile'} }
        	]
        	mans.sendMessage(m.chat, { caption: listmn, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '©KurrXd OFC', templateButtons: butRun, footer: `🌏 Dont Spam & Telpon Bot`, mentionedJid: [m.sender] })
        	break
...
case 'me': case 'inventori': case 'profile':{
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let butRun = [
        	...
        	mans.sendMessage(m.chat, { caption: teksehmazeh, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© KurrXd', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
        	}
        	break

/*case 'menu': case 'help': {
if (isBan) return m.reply(mess.ban)
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./media/KurrXd.jpg'), gifPlayback:true, jpegThumbnail:global.log0 }, { upload: mans.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
hydratedContentText: listmn,
hydratedFooterText: "© KurrXd||77+ - X - KurrXd||77+",
hydratedButtons: [{
urlButton: {
...
case 'groupbot':
case 'botgrup':
fakey(`https://chat.whatsapp.com/DhXoC9dA87V1zZyISwBEkF`)
break
case 'getscmd': {
if (isBan) return m.reply(mess.ban)
...
case 'wallpaper': {
		...
		let buttons = [
                ...
                let buttonMessage = {
                    ...
                    footer: `© Created KurrXd 77 ByFax`,
                    buttons: buttons,
                    headerType: 4
                }
...
case 'quotesimage':case 'qoutesimage':
				   ...
				   fakey(mess.wait)
				  mans.sendMessage(m.chat, { image: { url: cok }, caption: 'Done Subscribe Fax Botz' }, { quoted: m })
				  break
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "KurrXd||77+ ~ Multi Device", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
case 'nulis': {
if (isBan) return m.reply(mess.ban)
if (args.length < 1) return m.reply(`Example :\n${prefix}nulis KurrXd|91|#ff020a|Manusia terganteng adalah salman alfarizi`)
const nls = args.join(" ")
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"KurrXd||77+ - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"KurrXd||77+ - Facebook Downloader",
...
case 'iqra': {
		...
		mans.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf By Fax`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		case 'juzamma': {
		if (args[0] === 'pdf') {
...
mans.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"Ini Kak Jangan Lupa Subscribe Fax bot"}, {quoted:m})
break
case 'asupan-santuy':
case 'asupansantuy':
 fakey(mess.wait)
...
teks = tes.result
buffer = `https://telegra.ph/file/3d00c72d08a55bcd1abd0.jpg`
mans.sendMessage(from, {image:{url:buffer}, caption:teks}, {quoted:m})
break
case 'quotes':
